...
import 'package:project_helios/features/story/CaptionRayPage10.dart';

class captain_ray_page9 extends StatefulWidget {
  const captain_ray_page9({super.key});

  @override
  State<captain_ray_page9> createState() => _captain_ray_page9State();
}

class _captain_ray_page9State extends State<captain_ray_page9>
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    "A month later, I got to visit NASA!\n"
                    "A scientist showed me how satellites track space weather.\n"
                    "She said, “Every time the Sun bursts, we learn a little more about how to protect Earth\n"
                    "I realized that flying isn’t just about the sky — it’s about space, too.",
                    style: TextStyle(
                      fontSize: 16,
          ...
          Positioned(
            ...
            child: FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => captain_ray_page10()),
                );
              },
