...
import 'package:project_helios/features/story/CaptainRayPage3.dart';

class captain_ray_page2 extends StatefulWidget {
  const captain_ray_page2({super.key});

  @override
  State<captain_ray_page2> createState() => _captain_ray_page2State();
}

class _captain_ray_page2State extends State<captain_ray_page2>
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    "Hi! I'm Captain Ray — the youngest pilot at our flying school!\n"
                    "I've flown through cloudy days, rainy nights, and even a double rainbow once.\n"
                    "But I'll never forget the day I met a storm that didn't come from Earth… it came from the Sun! 🌞",
                    style: TextStyle(
                      fontSize: 16,
          ...
          Positioned(
            ...
            child: FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => captain_ray_page3()),
                );
              },
