...
import 'package:project_helios/features/story/CaptainRayPage2.dart';

class CaptainRayPage1 extends StatefulWidget {
  const CaptainRayPage1({super.key});

  @override
  State<CaptainRayPage1> createState() => _CaptainRayPage1State();
}

class _CaptainRayPage1State extends State<CaptainRayPage1>
        ...
        children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    ...
                    "Written & Illustrated by FlutterDevOps\n"
                    "Inspired by NASA’s Space Weather Research ☀",
                    style: TextStyle(
                      fontSize: 16,
          ...
          Positioned(
            ...
            child: FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  context, MaterialPageRoute(builder:(context)=>captain_ray_page2()),
                );
              },
