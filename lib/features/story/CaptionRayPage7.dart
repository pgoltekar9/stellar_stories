...
import 'package:project_helios/features/story/CaptionRayPage8.dart';

class captain_ray_page7 extends StatefulWidget {
  const captain_ray_page7({super.key});

  @override
  State<captain_ray_page7> createState() => _captain_ray_page7State();
}

class _captain_ray_page7State extends State<captain_ray_page7>
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    "Back in the air, I switched to backup systems — just like I’d practiced.\n"
                    "Then I saw it — the sky was glowing green and purple, even though it was still daylight!\n"
                    "It was the Aurora Borealis, caused by the same solar energy that made my GPS go wild!",
                    style: TextStyle(
                      fontSize: 16,
          ...
          Positioned(
            ...
            child: FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => captain_ray_page8()),
                );
              },
