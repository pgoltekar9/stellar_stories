...
import 'package:project_helios/features/story/CaptionRayPage6.dart';

class CaptainRayPage5 extends StatefulWidget {
  const CaptainRayPage5({super.key});

  @override
  State<CaptainRayPage5> createState() => _CaptainRayPage5State();
}

class _CaptainRayPage5State extends State<CaptainRayPage5>
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    "93 million miles away, the Sun sneezed!\n"
                    "BOOM! A wave of light and particles — a solar flare — raced through space faster than anything alive.\n"
                    "NASA’s satellites spotted it just in time and sent out a Space Weather Alert.",
                    style: TextStyle(
                      fontSize: 16,
          ...
          Positioned(
            ...
            child: FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => captain_ray_page6()),
                );
              },
