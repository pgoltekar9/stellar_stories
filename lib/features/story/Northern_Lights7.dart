...
import 'package:project_helios/features/story/Northern_LightsE.dart';

class AuroraPage7 extends StatefulWidget {
  const AuroraPage7({super.key});

  @override
  State<AuroraPage7> createState() => _AuroraPage7State();
}

class _AuroraPage7State extends State<AuroraPage7> with TickerProviderStateMixin {
        ...
        children: [
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: const [
                    ...
                    SizedBox(height: 10),
                    Text(
                      "With a heart full of wonder, Aurora knew her journey through the northern lights was a lesson of curiosity, "
                      "adventure, and the magic of observing the world around her.",
          ...
          Positioned(
            ...
            child: FloatingActionButton(
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (_) => AuroraEndPage()));
              },
