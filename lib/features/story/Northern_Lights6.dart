...
import 'package:project_helios/features/story/Northern_Lights7.dart';

class AuroraPage6 extends StatefulWidget {
  const AuroraPage6({super.key});

  @override
  State<AuroraPage6> createState() => _AuroraPage6State();
}

class _AuroraPage6State extends State<AuroraPage6> with TickerProviderStateMixin {
        ...
        children: [
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: const [
                    ...
                    SizedBox(height: 10),
                    Text(
                      "Every color, every wave of light, revealed a secret to those who truly watched. "
                      "Aurora felt connected to the stars and understood the harmony of nature, sky, and imagination.\n\n",
          ...
          Positioned(
            ...
            child: FloatingActionButton(
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (_) => AuroraPage7()));
              },
