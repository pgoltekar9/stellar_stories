...
import 'package:project_helios/features/story/CaptionRayPage7.dart';

class captain_ray_page6 extends StatefulWidget {
  const captain_ray_page6({super.key});

  @override
  State<captain_ray_page6> createState() => _captain_ray_page6State();
}

class _captain_ray_page6State extends State<captain_ray_page6>
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    "In Washington, NASA scientists watched the flare using the Solar Dynamics Observatory (SDO)\n"
                    "They tracked it, studied its speed, and sent messages to pilots, astronauts, and engineers around the world\n",
                    style: TextStyle(
                      fontSize: 16,
          ...
          Positioned(
            ...
            child: FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => captain_ray_page7()),
                );
              },
