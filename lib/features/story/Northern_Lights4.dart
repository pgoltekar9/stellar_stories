...
import 'package:project_helios/features/story/Northern_Lights5.dart';

class AuroraPage4 extends StatefulWidget {
  const AuroraPage4({super.key});

  @override
  State<AuroraPage4> createState() => _AuroraPage4State();
}

class _AuroraPage4State extends State<AuroraPage4> with TickerProviderStateMixin {
        ...
        children: [
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: const [
                    ...
                    SizedBox(height: 10),
                    Text(
                      "Aurora ventured deeper into wilderness, chasing the ribbons of light. "
                      "Each step revealed new hues dancing across the sky. "
                      "The magical lights whispered secrets of stars, guiding her forward.",
          ...
          Positioned(
            ...
            child: FloatingActionButton(
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (_) => AuroraPage5()));
              },
