...
import 'package:project_helios/features/story/CaptionRayPage5.dart';

class captain_ray_page4 extends StatefulWidget {
  const captain_ray_page4({super.key});

  @override
  State<captain_ray_page4> createState() => _captain_ray_page4State();
}

class _captain_ray_page4State extends State<captain_ray_page4>
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    "A few minutes into my flight, my radio started hissing.\n"
                    "Psssshh… Capt—Ray, can—you—hear—us?\n"
                    "The GPS showed my plane flying in circles — but I was going straight!\n"
                    "Something was messing with the signals!",
                    style: TextStyle(
                      fontSize: 16,
          ...
          Positioned(
            ...
            child: FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => CaptainRayPage5()),
                );
              },
