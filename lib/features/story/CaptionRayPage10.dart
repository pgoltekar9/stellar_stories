...
import 'package:project_helios/features/story/NebuleMessage.dart';

class captain_ray_page10 extends StatefulWidget {
  const captain_ray_page10({super.key});

  @override
  State<captain_ray_page10> createState() => _captain_ray_page10State();
}

class _captain_ray_page10State extends State<captain_ray_page10>
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    "Now, whenever I fly, I remember:\n"
                    "🌞 The Sun isn’t just light — it’s energy that reaches all the way to Earth.\n"
                    "⚡ Space weather can affect airplanes, satellites, and even power grids.\n"
                    "🛰 NASA scientists watch the Sun to keep us safe.\n"
                    "🌈 And sometimes… the storms from the Sun make the sky dance!",
                    style: TextStyle(
                      fontSize: 16,
          ...
          Positioned(
            ...
            child: FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => NebulaMessagePage()),
                );
              },
