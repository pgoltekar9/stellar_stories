...
import 'package:project_helios/features/story/CaptionRayPage4.dart';

class captain_ray_page3 extends StatefulWidget {
  const captain_ray_page3({super.key});

  @override
  State<captain_ray_page3> createState() => _captain_ray_page3State();
}

class _captain_ray_page3State extends State<captain_ray_page3>
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    ...
                    "The sky was clear, the air was calm, and the Sun was shining extra bright\n"
                    "I took off from Cloudyville Airport, headed north to deliver a small weather sensor to a research base",
                    style: TextStyle(
                      fontSize: 16,
          ...
          Positioned(
            ...
            child: FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => captain_ray_page4()),
                );
              },
